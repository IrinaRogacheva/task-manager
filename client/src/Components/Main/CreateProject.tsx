  ...
  <div style={{display: (view.isCreateProject?'block':'none')}}>
    ...
    <div className='create_project context-menu'>
        ...
        <div className='create_project_buttons-wrapper'>
            ...
            <button onClick={()=>{createProject();dispatch(setCreateProject(false))}} disabled={inputValue.length<1} className='create_project_save_button sidebar__text'>Сохранить</button>
        </div>
    </div>
  </div>
);}